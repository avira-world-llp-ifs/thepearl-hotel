...
import { TransitionLogo } from "./transition-logo"

interface EnhancedLogoTransitionProps {
  children: ReactNode
}

export function EnhancedLogoTransition({ children }: EnhancedLogoTransitionProps) {
